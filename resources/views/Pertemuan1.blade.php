...
<body>
  <p>
    ...
    <!-- target blank : tab baru ; self : pada halaman itu -->
    <!--# digunain untuk dummy link biasanya dan tidak pergi kemana mana tp kalo ada #... menuuju ke sectionnya-->

  </p>
  <h2>
    <font style="color: blue;">Bantu Adaptasi Mahasiswa Baru, ITS Gelar Mentoring Agama Islam</font>
  </h2>
  ...
  <p>
    <b class="kalimatpembuka">Kampus ITS, ITS News</b> — Institut Teknologi Sepuluh Nopember (ITS) kembali
